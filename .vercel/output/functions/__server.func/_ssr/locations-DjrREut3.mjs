//#region node_modules/.nitro/vite/services/ssr/assets/locations-DjrREut3.js
var UNN_CENTER = {
	lat: 6.8673,
	lng: 7.4085
};
...
function minutesAgo(mins) {
	return (/* @__PURE__ */ new Date(Date.now() - mins * 60 * 1e3)).toISOString();
}
var SAMPLE_WATER = [
	{
		id: "water-001",
...
function searchLocations(query) {
	...
	return getAllLocations().filter((loc) => loc.name.toLowerCase().includes(fuzzy) || loc.category.replace("_", " ").includes(fuzzy) || loc.description?.toLowerCase().includes(fuzzy) || loc.tags?.some((t) => t.includes(fuzzy)));
}
function categoryLabel(category) {
	return category.replaceAll("_", " ");
}
//#endregion
export { categoryLabel as a, UNN_CENTER as i, SAMPLE_FOOD as n, getAllLocations as o, SAMPLE_WATER as r, searchLocations as s, SAMPLE_ANNOUNCEMENTS as t };
